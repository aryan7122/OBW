  ...
  return (
    <section className="news-section">
      <div className="right">
        ...
        <h2>News & Articles</h2>
        <p className="sub">Lorem ipsum dolor sit amet consectetur. Mattis sapien amet a egestas.</p>
      </div>

      <div className="left">
        {articles.map((article, index) => (
          <div className={`news-card ${index === 0 ? "large" : "small"}`} key={index}>
            ...
            <div className="text">
              ...
              <div className="bottom">
                ...
                {index !== 0 && <span className="read">Read more</span>}
              </div>
            </div>
          </div>
        ))}
